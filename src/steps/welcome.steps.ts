...
Given(
  "I am on the Revance Welcome page",
...
When(
  "I enter the phone number {string}",
  async function (this: PlaywrightWorld, phone: string) {
...
Then(
  "the main heading should be {string}",
...
Then(
  "the Contact Us link should be visible",
  async function (this: PlaywrightWorld) {
    const contactLink = this.requirePage().getByRole("link", {
      name: /contact us/i,
    });
